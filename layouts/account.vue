        ...
        <div class="account-inner">
          <div class="md:grid md:grid-cols-3 md:gap-6">
            <aside class="block lg:w-64 md:col-span-" aria-label="Sidebar">
              <div class="overflow-y-auto md:py-4 md:px-3 md:bg-gray-50 text-base font-normal text-gray-500 rounded">
                <h1 class="self-center text-xl px-0 md:px-2 py-2 mb-2 font-semibold whitespace-nowrap">
                ...
                <ul class="space-y-2 list-none pl-0">
                  ...
                  <li>
                    <NuxtLink :to="formatLink(`/account/profile`)"
                      class="flex items-center px-0 md:px-2 py-2 rounded-lg hover:text-brand-primary hover:bg-gray-100 is-active">
                  ...
                  <li>
                    <NuxtLink :to="formatLink(`/account/address`)"
                  ...
                  <li>
                    <NuxtLink :to="formatLink(`/account/payment`)"
                      class="flex items-center px-0 md:px-2 py-2 rounded-lg hover:text-brand-primary hover:bg-gray-100">
                ...
                <ul class="pt-4 mt-4 space-y-2 border-t border-gray-200 list-none pl-0">
                  <li>
                    <NuxtLink :to="formatLink(`/account/order`)"
                      class="flex items-center px-0 md:px-2 py-2 rounded-lg hover:text-brand-primary hover:bg-gray-100">
